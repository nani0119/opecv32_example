...
void help(char *argv[])
{
    cout << "\n using homography to get a bird's eye view."
         << "\n This file relies on you having created an intrinsic file via example_18-01_from_disk"
         << "\n but here, that file is already stored in " RESOURCE_DIR"/19/birdseye/intrinsics.xml"
         << "\n Call:"
         << "\n" << argv[0] <<" <chessboard_width> <chessboard_height> <path/camera_calib_filename> <path/chessboard_image>"
         << "\n\n Example:"
         << "\n"<< argv[0] << " 12 12 " RESOURCE_DIR"/19/birdseye/intrinsics.xml " RESOURCE_DIR"/19/birdseye/IMG_0215L.jpg\n"
