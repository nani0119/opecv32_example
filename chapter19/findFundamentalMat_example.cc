...
void help(char *argv[])
{
    cout << "\nComputing the fundamental matrix using RANSAC relating 2 images. Show the camera a checkerboard "
         << "\nCall"
         << "\n "<< argv[0] << " <1:board_w> <2:board_h> <3:# of boards> <4:delay capture this many ms between frames> <5:scale the images 0-1>"
         << "\n\nExample call:"
         << "\n. " << argv[0] << " 9 6 20 500 0.5"
